...
export type ExternalProduct = ContentNode & DatabaseIdentifier & Node & NodeWithComments & NodeWithContentEditor & NodeWithFeaturedImage & Product & UniformResourceIdentifiable & {
  ...
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Product fields&quot; was set to Show in GraphQL. */
  productFields?: Maybe<Product_Productfields>;
...
export type MenuItemObjectUnion = Category | Page | Post | PostFormat | ProductCategory | ProductTag | Tag;
...
/** Field Group */
export type Product_Productfields = AcfFieldGroup & {
  __typename?: 'Product_Productfields';
  /** Please add &amp; crop custom thumbnail */
  croppedThumbnail?: Maybe<MediaItem>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
};
